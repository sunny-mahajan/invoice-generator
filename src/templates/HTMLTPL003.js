      ...
      ${invoiceData["Items"]
        ...
        ${
          ...
          <tr>
            ...
            <td style="padding-top: 30px;text-align:right; width: auto"><span class="currency-symbol-cls">${currencySymbol()}</span>${
            ...
            invoiceData.itemData["taxPercentage"] > 0
              ...
              ${
                ...
                <tr>
                  ...
                  <td style="text-align:right; width: auto"><span class="currency-symbol-cls">${currencySymbol()}</span>${
