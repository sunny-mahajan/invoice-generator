  ...
  <div class="temp3-container-cls">
    ...
    <div class="total-section">
        <div class="total-details">
            ...
            <h1><strong class="currency-symbol-cls">${currencySymbol}${
      ...
      ${invoiceData["Items"]
        .map(
          ...
          ${
            ...
            ${
              ...
              invoiceData.itemData["discount"] > 0
                ? `
              <td><div class="currency-symbol-cls"><span>${currencySymbol}</span>${item["afterDiscount"]}</div>
              </td>
            `
                : ""
            }
        ...
        ${
          ...
          <tr>
            ...
            <td style="padding-top: 30px;text-align:right; width: auto"><div class="currency-symbol-cls"><span>${currencySymbol}</span>${
            ...
            invoiceData.itemData["discount"] > 0
              ? `
                  <tr>
                    ...
                    <td style="text-align:right"><div class="currency-symbol-cls"><span>${currencySymbol}</span>${
            ...
            invoiceData.itemData["taxPercentage"] > 0
              ...
              ${
                ...
                <tr>
                  ...
                  <td style="text-align:right; width: auto"><div class="currency-symbol-cls"><span>${currencySymbol}</span>${
