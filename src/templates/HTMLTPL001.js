            ...
            <div class="sub-sec4-container">
                 <div class="sub-sec4-header">
                    ...
                    ${
                      ...
                      invoiceData.itemData["discount"] <= 0
                        ? `
                        <h2 class="sub-sec4-item-tax-amount">GST </h2>
                      `
                        : ""
                    }              
                ...
                ${invoiceData["Items"]
                  .map(
                    ...
                    <div class="sub-sec4-item" style="page-break-inside: avoid;">
                      ...
                      <p class="sub-sec4-item-price">${item["price"]}</p>
                      ...
                      ${
                        ...
                        (invoiceData.itemData["taxPercentage"] > 0 &&
                          invoiceData.itemData["discount"] <= 0)
                          ? `
                         <p class="sub-sec4-item-amount">${item["amount"]}
                        </p>
                        `
                          : ""
                      }
                      ${
                        ...
                        ${
                          ...
                          invoiceData.itemData["discount"] > 0
                            ? `
                          <p class="sub-sec4-item-amount">${item["afterDiscount"]}
                          </p>
                        `
                            : ""
                        }
                      ...
                      ${
                        ...
                        invoiceData.itemData["discount"] <= 0
                          ? `
                          <p class="sub-sec4-item-tax-amount">${item["taxAmount"]}</p>
                          `
                          : ""
                      }
                      <p class="sub-sec4-item-total">${item["total"]}</p>
                    </div>
                `
                  )
                  .join("")}
              ...
              ${
                ...
                ${
                  ...
                  <div class="sub-sec5-item">
                    ...
                    <span>${invoiceData.itemData["afterDiscountAmount"]}</span>
                  </div>
                  `
                    : ""
                }
