        ...
        <div class="sec4-container">
            <div class="sub-sec4-container">
                 <div class="sub-sec4-header">
                    ...
                    ${
                      invoiceData.itemData["taxPercentage"] > 0
                        ? `<h2 class="sub-sec4-item-tax">${invoiceData["Sender's Tax Type"] ? invoiceData["Sender's Tax Type"] : "TAX"} %</h2>
                    ...
                    ${
                      ...
                      invoiceData.itemData["discount"] <= 0
                        ? `
                        <h2 class="sub-sec4-item-tax-amount">${invoiceData["Sender's Tax Type"] ? invoiceData["Sender's Tax Type"] : "TAX"} <span>${currencySymbol}</span></h2>
                      `
                        : ""
                    }              
                    ...
                    <div class="sub-sec4-item" style="page-break-inside: avoid;">
                      ...
                      ${
                        ...
                        (invoiceData.itemData["taxPercentage"] > 0 &&
                          invoiceData.itemData["discount"] <= 0)
                          ? `
                         <p class="sub-sec4-item-amount "><span>${currencySymbol}</span>${item["amount"]}
                        </p>
                        `
                          : ""
                      }
                      ...
                      ${
                        ...
                        invoiceData.itemData["discount"] <= 0
                          ? `
                          <p class="sub-sec4-item-tax-amount "><span>${currencySymbol}</span>${item["taxAmount"]}</p>
                          `
                          : ""
                      }
